...
public class Cocinero extends Empleados {
	...
	public Cocinero(String usuario, String contraseña, String email, String nombre, String apellido, String telefono,
			String dNI, Contratos contrato, float salario, String aviso, String talla, String horario,int IDCocinero,
			int IDJ,String especialidad) {
